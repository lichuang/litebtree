...
void sqlite3PCacheSetDefault(void){
  ...
  /* btreelite: the default page cache is hard-bound at build time; the
  ** pluggable sqlite3_config() dispatch of SQLite is not available. */
  sqlite3Config.pcache2 = defaultMethods;
}
